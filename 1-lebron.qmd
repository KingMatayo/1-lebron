...
```{r warning=FALSE, message=FALSE,fig.align='center',fig.cap="Shots selection chart of Lebron's visit ever NBA game on Oct. 10, 2003. The league was a different world. Post-play dominated, and three-point shots were reserved for specialists."}
