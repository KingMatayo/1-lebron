...
# Generate's Lebron's slope chart with the function created
...
base_lebron_linechart <- create_linechart(all_shots,"LeBron James",2003,2008)

lebron_linechart_03_08_v2 <- base_lebron_linechart +
  # Animation: reveal a path per season
  transition_reveal(season) +
  labs(
    title = "LeBron James % of Shot Choices by Court Zone and by Season (2003-08)",
